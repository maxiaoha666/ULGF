...
from utils.data.mask_loss.ruodrandom2 import RUODDataset
from utils.data.mask_loss.urpcrandom2 import URPCDataset
...
def parse_args():
    ...
    parser.add_argument("--uncond_prob", type=float, default=0.0,
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            if torch.isnan(batch["bbox_mask"]).any():
                print(1)
            ...
            if global_step % args.save_ckpt_freq == 0:
                ...
                if accelerator.is_local_main_process:
                    ...
                    pipeline = StableDiffusionPipeline(
                        text_encoder=text_encoder if not args.train_text_encoder else accelerator.unwrap_model(
                            text_encoder),
                        vae=vae,
                        unet=unet_module,
                        tokenizer=tokenizer,
